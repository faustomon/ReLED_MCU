...
CPP_SRCS += \
../src/1-modulos/02-gpio/Gpio.cpp 

CPP_DEPS += \
./src/1-modulos/02-gpio/Gpio.d 

OBJS += \
./src/1-modulos/02-gpio/Gpio.o 


# Each subdirectory must supply rules for building sources it contributes
src/1-modulos/02-gpio/%.o: ../src/1-modulos/02-gpio/%.cpp src/1-modulos/02-gpio/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-1-2d-modulos-2f-02-2d-gpio

clean-src-2f-1-2d-modulos-2f-02-2d-gpio:
	-$(RM) ./src/1-modulos/02-gpio/Gpio.d ./src/1-modulos/02-gpio/Gpio.o

.PHONY: clean-src-2f-1-2d-modulos-2f-02-2d-gpio
