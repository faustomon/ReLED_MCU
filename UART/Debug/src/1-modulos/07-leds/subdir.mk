...
CPP_SRCS += \
../src/1-modulos/07-leds/Led.cpp 

CPP_DEPS += \
./src/1-modulos/07-leds/Led.d 

OBJS += \
./src/1-modulos/07-leds/Led.o 


# Each subdirectory must supply rules for building sources it contributes
src/1-modulos/07-leds/%.o: ../src/1-modulos/07-leds/%.cpp src/1-modulos/07-leds/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-1-2d-modulos-2f-07-2d-leds

clean-src-2f-1-2d-modulos-2f-07-2d-leds:
	-$(RM) ./src/1-modulos/07-leds/Led.d ./src/1-modulos/07-leds/Led.o

.PHONY: clean-src-2f-1-2d-modulos-2f-07-2d-leds
