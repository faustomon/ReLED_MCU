...
CPP_DEPS += \
./src/1-modulos/09-teclado/Teclado.d 

OBJS += \
./src/1-modulos/09-teclado/Teclado.o 


# Each subdirectory must supply rules for building sources it contributes
src/1-modulos/09-teclado/%.o: ../src/1-modulos/09-teclado/%.cpp src/1-modulos/09-teclado/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-1-2d-modulos-2f-09-2d-teclado

clean-src-2f-1-2d-modulos-2f-09-2d-teclado:
	-$(RM) ./src/1-modulos/09-teclado/Teclado.d ./src/1-modulos/09-teclado/Teclado.o

.PHONY: clean-src-2f-1-2d-modulos-2f-09-2d-teclado
