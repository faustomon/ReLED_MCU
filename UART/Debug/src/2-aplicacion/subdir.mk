...
../src/2-aplicacion/main.cpp 

CPP_DEPS += \
./src/2-aplicacion/aplicacion.d \
./src/2-aplicacion/inicializarInfotronic.d \
./src/2-aplicacion/main.d 

OBJS += \
./src/2-aplicacion/aplicacion.o \
./src/2-aplicacion/inicializarInfotronic.o \
./src/2-aplicacion/main.o 


# Each subdirectory must supply rules for building sources it contributes
src/2-aplicacion/%.o: ../src/2-aplicacion/%.cpp src/2-aplicacion/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-2-2d-aplicacion

clean-src-2f-2-2d-aplicacion:
	-$(RM) ./src/2-aplicacion/aplicacion.d ./src/2-aplicacion/aplicacion.o ./src/2-aplicacion/inicializarInfotronic.d ./src/2-aplicacion/inicializarInfotronic.o ./src/2-aplicacion/main.d ./src/2-aplicacion/main.o

.PHONY: clean-src-2f-2-2d-aplicacion
