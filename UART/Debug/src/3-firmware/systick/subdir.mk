...
CPP_SRCS += \
../src/3-firmware/systick/systick.cpp 

CPP_DEPS += \
./src/3-firmware/systick/systick.d 

OBJS += \
./src/3-firmware/systick/systick.o 


# Each subdirectory must supply rules for building sources it contributes
src/3-firmware/systick/%.o: ../src/3-firmware/systick/%.cpp src/3-firmware/systick/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-3-2d-firmware-2f-systick

clean-src-2f-3-2d-firmware-2f-systick:
	-$(RM) ./src/3-firmware/systick/systick.d ./src/3-firmware/systick/systick.o

.PHONY: clean-src-2f-3-2d-firmware-2f-systick
